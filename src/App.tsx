...
import { predictHealthRisks, type HealthData, type PredictionResult } from './services/geminiService';
...
export default function App() {
  const [view, setView] = React.useState<'landing' | 'dashboard' | 'form' | 'history'>('landing');
  ...
  return (
    <div className={cn("min-h-screen text-slate-900 font-sans", view === 'landing' ? "bg-[#F9A8C9]" : "bg-slate-50")}>
      {/* Navigation */}
      <nav className={cn("sticky top-0 z-50 border-b", view === 'landing' ? "bg-[#F9A8C9]/80 backdrop-blur-md border-pink-200" : "bg-white/80 backdrop-blur-md border-slate-200")}>
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2 cursor-pointer" onClick={() => setView('landing')}>
            <div className={cn("w-10 h-10 rounded-xl flex items-center justify-center text-white shadow-lg", view === 'landing' ? "bg-[#E91E63]" : "bg-emerald-600")}>
              <Activity size={24} />
            </div>
          ...
          <div className="hidden md:flex items-center gap-8">
            <button onClick={() => setView('landing')} className="text-sm font-medium hover:text-[#E91E63] transition-colors">Features</button>
            <button onClick={() => setView('landing')} className="text-sm font-medium hover:text-[#E91E63] transition-colors">Reviews</button>
            <button onClick={() => {}} className="text-sm font-medium hover:text-[#E91E63] transition-colors">Drug Detection</button>
            <button onClick={findHospitals} className="text-sm font-medium hover:text-[#E91E63] transition-colors">Hospitals</button>
            <button onClick={() => setView('dashboard')} className="text-sm font-medium hover:text-[#E91E63] transition-colors">Dashboard</button>
          </div>

          <div className="flex items-center gap-3">
            <Button onClick={() => setView('form')} className={cn("flex items-center gap-2", view === 'landing' ? "bg-[#E91E63] hover:bg-[#D81B60]" : "")}>
              <Plus size={18} />
              <span className="hidden sm:inline">Check Your Health</span>
            </Button>
            <button className="p-2 rounded-xl border border-slate-200 hover:bg-white/20 transition-colors">
              <Globe size={20} />
            </button>
          </div>
        </div>
            ...
            >
              ...
              <section className="max-w-7xl mx-auto px-4 pt-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="relative">
                  ...
                  >
                    <img 
                      src="https://picsum.photos/seed/medical-ai/800/800" 
              ...
              <Card className="p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <textarea 
                      className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 outline-none transition-all min-h-[100px]"
      ...
      <footer className="bg-white border-t border-slate-200 py-12 mt-20">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex items-center gap-6">
            <a href="#" className="text-slate-400 hover:text-emerald-600 transition-colors"><Info size={20} /></a>
            <a href="#" className="text-slate-400 hover:text-emerald-600 transition-colors"><User size={20} /></a>
            <a href="#" className="text-slate-400 hover:text-emerald-600 transition-colors"><LogOut size={20} /></a>
          </div>
        </div>
      </footer>
    </div>
